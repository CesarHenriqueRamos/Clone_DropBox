class DropBoxController{
    ...
    connectFireBase(){
        // Your web app's Firebase configuration
            var firebaseConfig = {
                apiKey: "AIzaSyAwzOrWj1V9rOYmgTZXh2DZ2-RR881Uj3U",
                authDomain: "dropbox-clone-f7e83.firebaseapp.com",
                databaseURL: "https://dropbox-clone-f7e83.firebaseio.com",
                projectId: "dropbox-clone-f7e83",
                storageBucket: "dropbox-clone-f7e83.appspot.com",
                messagingSenderId: "1089046252919",
                appId: "1:1089046252919:web:da2cd34db9f2b10afe6572",
                measurementId: "G-7R1F3GYYHE"
            };
            // Initialize Firebase
    ...
    initEvent(){
        ...
        this.listFileEl.addEventListener('selectionchange', e=>{
            //console.log('selection',this.getSelector().length);
            switch(this.getSelector().length){
                case 0:
    ...
    modalShow(modal = true){
        this.snackModalEl.style.display = (modal) ? 'block':'none';
    }
    //metodo ajax
